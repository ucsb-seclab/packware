...
def ratio_plot_diffpackedbenign(filepath):
    ...
    ax.set_xlabel('Packed benign ratio (training)', fontsize=FONTSIZE)
    ...
    ax.legend(loc="upper right", fancybox=True, framealpha=0.5, fontsize=FONTSIZE)
    plt.savefig('{}/diff-packed-benign-ratio-plot.pdf'.format(plots_path), bbox_inches='tight')
    plt.close()
