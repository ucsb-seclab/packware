...
do
    echo PACKER $packer
    python training.py config_exp-withheldpacker $1 lab-v3 $packer ngrams
...
do
    echo PACKER $packer
    respath=../../results/paper/experiments/exp-withheldpacker/$1/lab-v3/$packer/dll-generic-header-import-opcodes-rich-sections-strings
    db=$respath/exp.db
    json=$db.json
    csv=$db.csv
