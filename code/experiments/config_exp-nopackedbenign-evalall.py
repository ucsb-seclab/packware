...
def divide_dataset(indices, ratio_ben, ratio_mal, seed):
    ...
    training_packed_malicious, testing_packed_malicious = divide_set(packed_malicious, 0.9, seed=seed)
    training_unpacked_benign, testing_unpacked_benign   = divide_set(unpacked_benign, 0.9, seed=seed)
