...
do
    echo PACKER $packer
    python training.py config_exp-singlepacker $1 lab-v3 $packer rich
    echo DONE WITH TRAINING/TESTING of $packer
done
packer=dolphin-dropper-3
echo PACKER $packer
python training.py config_exp-singlepacker $1 lab-dropper $packer rich
echo DONE WITH TRAINING/TESTING of $packer
...
do
    echo PACKER $packer
    respath=../../results/paper/experiments/exp-singlePacker/$1/lab-v3/$packer/rich
    db=$respath/exp.db
    json=$db.json
    csv=$db.csv
...
packer=dolphin-dropper-3
echo PACKER $packer
respath=../../results/paper/experiments/exp-singlePacker/$1/lab-dropper/$packer/rich
db=$respath/exp.db
json=$db.json
csv=$db.csv
python process_sql.py $db
