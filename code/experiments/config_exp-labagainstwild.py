...
if features == 'all' or ['all'] == features:
    res_dir = '{}/exp-labagainstwild/{}/{}/all'.format(exp_util.RES_ROOT, model_name, src)
else:
    res_dir = '{}/exp-labagainstwild/{}/{}/{}/'.format(exp_util.RES_ROOT, model_name,
                                                       src, '-'.join(sorted(features)))
