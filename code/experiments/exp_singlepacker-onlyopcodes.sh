...
do
    echo PACKER $packer
    python training.py config_exp-singlepacker $1 lab-v3 $packer opcodes
    echo DONE WITH TRAINING/TESTING of $packer
done
packer=dolphin-dropper-3
echo PACKER $packer
python training.py config_exp-singlepacker $1 lab-dropper $packer opcodes
echo DONE WITH TRAINING/TESTING of $packer
...
do
    echo PACKER $packer
    respath=../../results/paper/experiments/exp-singlePacker/$1/lab-v3/$packer/opcodes
    db=$respath/exp.db
    json=$db.json
    csv=$db.csv
...
packer=dolphin-dropper-3
echo PACKER $packer
respath=../../results/paper/experiments/exp-singlePacker/$1/lab-dropper/$packer/opcodes
db=$respath/exp.db
json=$db.json
csv=$db.csv
python process_sql.py $db
