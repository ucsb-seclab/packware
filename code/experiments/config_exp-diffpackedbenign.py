...
if features == 'all' or ['all'] == features:
    res_dir = '{}/exp-diffPackedBenign/{}/all'.format(exp_util.RES_ROOT, model_name)
else:
    res_dir = '{}/exp-diffPackedBenign/{}/{}'.format(exp_util.RES_ROOT, model_name, '-'.join(sorted(features)))
