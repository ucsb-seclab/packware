...
if features == 'all' or ['all'] == features:
    res_dir = '{}/exp-labDiffPackedBenign/{}/all'.format(exp_util.RES_ROOT, model_name)
else:
    res_dir = '{}/exp-labDiffPackedBenign/{}/{}'.format(exp_util.RES_ROOT, model_name, '-'.join(sorted(features)))
